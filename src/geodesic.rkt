...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname geodesic) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
(require spd/tags)
...
;; GEODESIC.rkt
;;
;; Functions for procedurally generating geodesic polyhedra (icospheres)
;;
