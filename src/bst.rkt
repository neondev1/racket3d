...
(check-expect (lookup BST1 2) 2)
(check-expect (lookup BST3 1) 1)
(check-expect (lookup BST2 0) 0)
(check-expect (lookup BST2 4) false)
...
(check-expect (set-right BST1 false) BST1)
(check-expect (set-right BST1 (make-node 5 5
              ...
              (make-node 3 3
                         ...
                         (make-node 5 5
                                    (make-node 4 4 false false)
                                    (make-node 6 6 false false))))
(check-expect (set-right BST2 false)
              (make-node 2 2
                         (make-node 0 0
                                    false
                                    (make-node 1 1 false false))
